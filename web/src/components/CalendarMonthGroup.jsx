...
export const CalendarMonthGroup = ({startYear, startMonth, setStartYearMonth, numMonths, events, setEvent, addEventLabel, allowAdds, allowDeletes, header, knownEvents}) => {
